...
# ================================================================
# 📱 PWA CONFIGURATION FOR LANZOFIELDS - FIXED
# ================================================================
...
PWA_APP_SPLASH_SCREEN = [
    {
        'src': '/static/dashboard/img/640x1136.png',
        'media': '(device-width: 320px) and (device-height: 568px) and (-webkit-device-pixel-ratio: 2)'
    }
]

# ✅ FIXED SERVICE WORKER PATH
PWA_SERVICE_WORKER_PATH = os.path.join(BASE_DIR, 'dashboard', 'static', 'dashboard', 'js', 'serviceworker.js')